(function () {
  ...
  // i18n parity checklist:
  // - if a key is added/changed in `de`, mirror it in `en`
  // - keep wording plain for first-time users
  const I18N = {
    en: {
      ...
      "progress.upload": "Profile",
      "progress.questions": "Confirm",
      "progress.review": "Check & Generate",
      "progress.result": "Result",
      "progress.step_of": "Step {current} of {total}",

      "start.title": "Start your application",
      "start.sub": "Paste the job ad, add optional company/position details, then confirm consent.",
      "start.what_you_need": "Before you continue",
      "start.need_job_ad": "Job ad text (required)",
      "start.need_contact": "Company + position (optional)",
      "start.need_cv": "Consent checkbox (required)",
      "start.need_docs": "CV, letters, certificates (optional but helpful)",
      "start.auto_start": "Your progress is saved automatically.",

      "questions.title": "Questions",
      "questions.sub": "Please confirm missing details.",
      "review.title": "Check and generate",
      "review.sub": "Pick a template, check the match score, then decide if you want to generate.",
      "review.no_score": "No review score yet.",

      "upload.page_title": "Enter your CV details",
      "upload.page_sub": "Add your details section by section. Keep facts clear and short.",
      ...
      "upload.cv_contact_help": "Example: full name, email, phone, city, LinkedIn.",
      ...
      "upload.cv_skills_help": "Add exact tools and skills you have used (for example: Python, SQL, Jira).",
      ...
      "upload.cv_experience": "Work history",
      "upload.cv_experience_help": "One role per entry. Include tasks and measurable results.",
      "upload.cv_add_experience": "+ Add Experience",
      "upload.cv_education": "Education",
      "upload.cv_education_help": "Add degree, school, and dates. Include key learnings if useful.",
      ...
      "action.save_answers": "Save and continue",
      "action.preview_match": "Check match score",
      ...
      "action.continue_upload": "Continue to profile",
      "action.continue_questions": "Continue to confirm details",
      "action.continue_review": "Continue to check",
      ...
      "comparison.keywords_title": "Keyword comparison: job ad vs your CV",
      "comparison.keywords_help": "Keywords are extracted from the job ad. Missing terms are listed below.",
      ...
      "quality.title": "Text quality check",
      ...
      "optimization.title": "What changed in your CV",
      "optimization.subtitle": "Original wording vs optimized wording, based on job-ad keywords.",
      ...
      "adv.profile_title": "Optional: Enter profile manually",
      "adv.telos_title": "Optional: Career goals and values",
      "adv.contact": "Contact",
    ...
    de: {
      ...
      "progress.start": "Start",
      "progress.upload": "Profil",
      "progress.questions": "Bestätigen",
      "progress.review": "Prüfen & Generieren",
      "progress.result": "Resultat",
      "progress.step_of": "Schritt {current} von {total}",

      "start.title": "Bewerbung starten",
      "start.sub": "Inserat einfügen, optional Firma/Position ergänzen, dann Einwilligung bestätigen.",
      "start.what_you_need": "Vor dem Weitergehen",
      "start.need_job_ad": "Job-Inserat Text (pflicht)",
      "start.need_contact": "Firma + Position (optional)",
      "start.need_cv": "Einwilligung Checkbox (pflicht)",
      "start.need_docs": "CV, Zeugnisse, Zertifikate (optional, aber hilfreich)",
      "start.auto_start": "Dein Fortschritt wird automatisch gespeichert.",

      "questions.title": "Fragen",
      "questions.sub": "Bitte fehlende Angaben bestätigen.",
      "review.title": "Prüfen und generieren",
      "review.sub": "Vorlage wählen, Match-Score prüfen, dann über Generierung entscheiden.",
      "review.no_score": "Noch kein Review-Score.",

      "upload.page_title": "CV Daten eingeben",
      "upload.page_sub": "Daten Abschnitt für Abschnitt ergänzen. Kurz und sachlich bleiben.",
      ...
      "upload.cv_contact_help": "Beispiel: Vollname, E-Mail, Telefon, Ort, LinkedIn.",
      ...
      "upload.cv_skills": "Skills",
      "upload.cv_skills_help": "Nur konkrete Skills/Tools eintragen, die du wirklich genutzt hast (z.B. Python, SQL, Jira).",
      ...
      "upload.cv_experience": "Beruflicher Werdegang",
      "upload.cv_experience_help": "Pro Station ein Eintrag. Aufgaben und messbare Ergebnisse nennen.",
      "upload.cv_add_experience": "+ Erfahrung hinzufügen",
      "upload.cv_education": "Ausbildung",
      "upload.cv_education_help": "Abschluss, Schule und Zeitraum eintragen. Wichtige Lerninhalte optional ergänzen.",
      ...
      "action.save_answers": "Speichern und weiter",
      "action.generate_cv": "CV generieren",
      "action.generate_cover": "Anschreiben generieren",
      "action.generate": "CV + Anschreiben generieren",
      "action.preview_match": "Match-Score prüfen",
      "action.download_cv": "CV herunterladen",
      "action.continue_upload": "Weiter zum Profil",
      "action.continue_questions": "Weiter zum Bestätigen",
      "action.continue_review": "Weiter zum Prüfen",
      ...
      "comparison.keywords_title": "Keyword Vergleich: Inserat vs dein CV",
      "comparison.keywords_help": "Keywords werden aus dem Inserat extrahiert. Fehlende Begriffe sind unten gelistet.",
      ...
      "quality.title": "Textqualitäts-Check",
      ...
      "optimization.title": "Was im CV angepasst wurde",
      "optimization.subtitle": "Originale Formulierung vs optimierte Formulierung basierend auf Inserat-Keywords.",
      "optimization.original": "Original",
      ...
      "adv.profile_title": "Optional: Profil manuell eingeben",
      "adv.telos_title": "Optional: Karriereziele und Werte",
      "adv.contact": "Kontakt",
