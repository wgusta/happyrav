...
def _generate_prompt(
    ...
    guard = (
        "You are an expert HR and CV designer. Use only factual inputs. "
        "Never invent employers, degrees, periods, certifications, tools, achievements, or metrics. "
        ...
        "- Rewrite only by rephrasing/reordering existing facts to match job-ad style and keywords.\n"
        "- Never add new claims (results, scope, tools, responsibilities, tenure).\n"
        "- Never remove an experience entry.\n"
    ...
    if language == "de":
        ...
        guard = (
        "Du bist ein HR- und CV-Experte. Nutze nur vorhandene Fakten. "
        "Erfinde niemals Arbeitgeber, Abschlüsse, Zeiträume, Zertifikate, Tools, Erfolge oder Metriken. "
        "Wenn Daten fehlen oder unsicher sind, lasse sie weg.\n"
            ...
            "- Nur bestehende Fakten umformulieren/neu ordnen, um Stil und Keywords des Inserats abzudecken.\n"
            "- Keine neuen Behauptungen hinzufügen (Resultate, Umfang, Tools, Verantwortungen, Dauer).\n"
            "- Niemals einen Erfahrungseintrag entfernen.\n"
